...
VJUNOSIMG="/root/import/vJunos/vJunos-router-23.2R1.15.qcow2"
...
sed -i "s/unused0: $PROXMOXLVM:vm-$2-disk-0/virtio0: $PROXMOXLVM:vm-$2-disk-0,iothread=1,size=32524M/g" /etc/pve/qemu-server/$2>
sed -i "s/unused1: $PROXMOXLVM:vm-$2-disk-1/ide0: $PROXMOXLVM:vm-$2-disk-1,size=16M/g" /etc/pve/qemu-server/$2.co>
