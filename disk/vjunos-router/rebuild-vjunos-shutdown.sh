...
sed -i "s/unused0: hdd-lvm:vm-$2-disk-0/virtio0: hdd-lvm:vm-$2-disk-0,iothread=1,size=32524M/g" /etc/pve/qemu-server/$2>
sed -i "s/unused1: hdd-lvm:vm-$2-disk-1/ide0: hdd-lvm:vm-$2-disk-1,size=16M/g" /etc/pve/qemu-server/$2.co>
